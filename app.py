...
# ==========================================
# LISTA DE API KEYS DE RESPALDO (ROTACIÓN AUTOMÁTICA)
# ==========================================
API_KEYS_BASE = [
    "14db0e108529faed46c94b3163188df5",  # Clave 1
    "3e69e51ac95c094a672f790edac978b0"   # Clave 2
]
HOST, APP_NAME = "v3.football.api-sports.io", "Pronósticador Élite Profesional"

# ==========================================
# FUNCIONES AUXILIARES Y LIMPIEZA DE NOMBRES
# ==========================================
...
# ==========================================
# CLIENTE API FOOTBALL AUTOMÁTICO
# ==========================================
class FootballAPI:
    def __init__(self):
    ...
    def consultar(self, endpoint: str, params: dict) -> list:
        ...
        self.ultimo_error = f"🛑 Error de API Keys (Cuentas Suspendidas o Sin Saldo): {detalles if detalles else 'Revisa la activación de tus claves en api-football.com'}"
        return []
