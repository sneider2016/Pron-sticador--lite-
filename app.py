        ...
        for q in intentos:
            ...
            if res:
                ...
                for item in res:
                    ...
                    sc = similarity(normalizar(q), normalizar(t_info.get("name", "")))
    ...
    def buscar_partido(self, local: str, visitante: str, fecha: str):
        ...
        if partidos:
            ...
            for p in partidos:
                ...
                sc = (similarity(norm_l, normalizar(l_api)) + similarity(norm_v, normalizar(v_api))) / 2.0
                if sc > 40 and sc > max_s: max_s, mejor = sc, p
...
class Analyzer:
    ...
    def analizar(self, datos: dict) -> dict:
        ...
        prom_h2h = round(tot_h2h / len(h2h), 2) if h2h else round(gf_h + gf_v, 2)
